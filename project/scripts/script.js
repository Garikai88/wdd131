...
const services = [
...

    {
        ...
        image: "project/images/cemmercial-icon.webp"
    },
...
projects.forEach(project => {
    ...
    <p>Price: ${formatCurrency(getDiscountedPrice(project.price))}</p>
...
grid.addEventListener("click", e => {
    if (e.target.tagName === "BUTTON") {
        ...
        localStorage.setItem("savedProject", JSON.stringify(selecetd));
